...
export const routes: Routes = [
    ...
    { path: 'productos', title: "Productos 💸",component: ProductosComponent,
     ...
     { path: 'productos/crear-producto', title: "Crear Producto", component: CrearProductoComponent},
     { path: 'productos/editar-producto', title: "Editar Producto", component: EditarProductoComponent},
     { path: 'productos/ver-producto', title: "Producto", component: VerProductoComponent},
